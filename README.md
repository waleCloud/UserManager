...
* Clone the repository by entering the command `git clone https://github.com/waleCloud/UserManager.git` in the terminal.
...
```
* After this, you can then start the server with the command: `npm start`, or `sh runApp` a bash Script
* if you have docker-compose  installed, i have a helper script named runApp to help Automate the process from bash
